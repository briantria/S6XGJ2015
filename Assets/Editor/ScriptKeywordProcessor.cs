/*
 * source: http://www.sarpersoher.com/unity-script-template-keyword-replacer/
 *
 */
...
{
	// This script currently contains 2 keywords, feel free to add more
	// #CREATIONDATE#
	// #DEVELOPERNAME#
	...
	public static void OnWillCreateAsset(string path) {
		...
		file = file.Replace("#DEVELOPERNAME#", "brian g. tria");
